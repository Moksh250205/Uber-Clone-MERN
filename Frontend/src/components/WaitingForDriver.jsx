...
const WaitingForDriver = ({setWaitingForDriver, setRideConfirmation}) => {
  return (
    <div>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='text-right'>
          ...
          <h1 className='text-lg font-semibold'>Abhi 69 </h1>
        </div>
      </div>
        ...
        <div className='w-full mt-5'>
          <div className='flex items-center gap-5 p-3 border-b-2'>
            ...
            <div>
              ...
              <p className='text-sm -mt-1 text-gray-600'>Abhi firse 69</p>
            </div>
          </div>
          <div className='flex items-center gap-5 p-3 border-b-2'>
            ...
            <div>
              <h3 className='text-lg font-medium'>562/11-A</h3>
              <p className='text-sm -mt-1 text-gray-600'>Nice</p>
            </div>
          </div>
